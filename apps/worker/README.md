...
ワーカー向けのサンプルアプリケーションです。このアプリケーションは、モノレポ構成の Convex + Next.js プロジェクトの一部として作成されています。

## 📋 概要

このアプリケーションは、ワーカー向けのダッシュボードや機能を提供するサンプルアプリケーションです。

- **ポート**: 3001
- **フレームワーク**: Next.js 16
- **バックエンド**: Convex
- **認証**: Convex Auth（`worker` ロール）
